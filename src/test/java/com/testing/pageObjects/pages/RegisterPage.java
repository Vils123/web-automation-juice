...
public class RegisterPage extends TopMenuSection {
  ...
  public static By SECURITY_QUESTION = xpath("//*[@id=\"registration-form\"]/div[1]/mat-form-field[1]/div/div[1]/div[3]");
  public static By NAME_OF_FAVORITE_PET_OPTION = css("mat-option[id='mat-option-9']");
  public static By SECURITY_QUESTION_LIST = css("div[aria-label='Selection list for the security question'] > mat-option");
