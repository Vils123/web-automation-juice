...
public class HomePage extends TopMenuSection {
  ...
  public static By ITEMS_PER_PAGE = css("mat-paginator mat-form-field");
  public static By OPTION_24 = id("mat-option-1");
  public static By BLOCK_NAME = css("mat-grid-list > div > mat-grid-tile");
  public static By ADD_TO_BASKET_BUTTON = ariaLabel("Add to Basket");
  public static By PRODUCT_INFO_BLOCK = css("mat-dialog-content > div > div[1] > div[2] > div[1]");
  public static By PRODUCT_INFO_PRICE = css("mat-dialog-content > div > div[1] > div[2] > div[2] > p");
  public static By PRODUCT_INFO_CLOSE = ariaLabel("Close Dialog");
  public static By REVIEWS_EXPAND = css("mat-expansion-panel");
  public static By COMMENT_SECTION  = css("mat-expansion-panel > div > div > div");
  public static By REVIEW_TEXT_FIELD  = css("textarea");
  ...
  public Boolean validateItemList(DataTable data){
    ...
    int expectedAmountOfItems = Integer.parseInt(dataToMap(data).get(0).get("Amount"));
    int actualAmountOfItems = getElements(BLOCK_NAME).size();

    info("Found: " + actualAmountOfItems + ", expected: " + expectedAmountOfItems);
    return expectedAmountOfItems == actualAmountOfItems;
  }
